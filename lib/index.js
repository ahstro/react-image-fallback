...
var ReactImageFallback = (function (_Component) {
	...
	_createClass(ReactImageFallback, [{
		...
		value: function componentWillReceiveProps(nextProps) {
			...
			var imageSource = _state.imageSource;
			var imageArray = _state.imageArray;

			var nextArray = getImageArray(nextProps);
			if (!imageArray.every(function (image, index) {
				return nextArray[index] === image;
			})) this.setState({
		...
		value: function setDisplayImage() {
			...
			this.displayImage.onload = function () {
				...
				var imageArray = _state3.imageArray;
				var imageIndex = _state3.imageIndex;
		...
		value: function render() {
			...
			var imageSource = _state4.imageSource;
			var broken = _state4.broken;
			var hasInitial = _state4.hasInitial;
